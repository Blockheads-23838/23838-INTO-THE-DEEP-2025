...
public  class Constants {
    ...
    public static double pivot_high_pose = 1345;//1457.3404, 3800; //encoder counts; highest the arm should go; high basket
    public static double pivot_high_pose_2 = 1372;
    ...
    public static double slide_specimen_high_rung = 1320; //TEST TO GET THIS VALUE!!!
